...
const chapters: Chapter[] = [
  ...
  // ── CLASS 7 SCIENCE ───────────────────────────────────────────
  { id: "7-science-1",  classNum: 7, subject: "science", num: 1,  difficulty: "elementary", title: "The Ever-Evolving World of Science",              emoji: "🔭", videoId: "" },
  { id: "7-science-2",  classNum: 7, subject: "science", num: 2,  difficulty: "elementary", title: "Exploring Substances: Acidic, Basic, and Neutral", emoji: "⚗️", videoId: "" },
  { id: "7-science-3",  classNum: 7, subject: "science", num: 3,  difficulty: "advanced",   title: "Electricity: Circuits and their Components",      emoji: "⚡", videoId: "" },
  { id: "7-science-4",  classNum: 7, subject: "science", num: 4,  difficulty: "elementary", title: "The World of Metals and Non-metals",              emoji: "⚙️", videoId: "" },
  { id: "7-science-5",  classNum: 7, subject: "science", num: 5,  difficulty: "advanced",   title: "Changes Around Us: Physical and Chemical",        emoji: "🔬", videoId: "" },
  { id: "7-science-6",  classNum: 7, subject: "science", num: 6,  difficulty: "elementary", title: "Adolescence: A Stage of Growth and Change",       emoji: "🧬", videoId: "" },
  { id: "7-science-7",  classNum: 7, subject: "science", num: 7,  difficulty: "elementary", title: "Heat Transfer in Nature",                         emoji: "🌡️", videoId: "" },
  { id: "7-science-8",  classNum: 7, subject: "science", num: 8,  difficulty: "elementary", title: "Measurement of Time and Motion",                  emoji: "⏱️", videoId: "" },
  { id: "7-science-9",  classNum: 7, subject: "science", num: 9,  difficulty: "advanced",   title: "Life Processes in Animals",                       emoji: "🐾", videoId: "" },
  { id: "7-science-10", classNum: 7, subject: "science", num: 10, difficulty: "elementary", title: "Life Processes in Plants",                        emoji: "🌱", videoId: "" },
  { id: "7-science-11", classNum: 7, subject: "science", num: 11, difficulty: "elementary", title: "Light: Shadows and Reflections",                  emoji: "💡", videoId: "" },
  { id: "7-science-12", classNum: 7, subject: "science", num: 12, difficulty: "advanced",   title: "Earth, Moon, and the Sun",                        emoji: "🌍", videoId: "" },
  ...
  // ── CLASS 8 SCIENCE ───────────────────────────────────────────
  { id: "8-science-1",  classNum: 8, subject: "science", num: 1,  difficulty: "elementary", title: "Exploring the Investigative World of Science",             emoji: "🔭", videoId: "" },
  { id: "8-science-2",  classNum: 8, subject: "science", num: 2,  difficulty: "elementary", title: "The Invisible Living World: Beyond Our Naked Eye",         emoji: "🦠", videoId: "" },
  { id: "8-science-3",  classNum: 8, subject: "science", num: 3,  difficulty: "elementary", title: "Health: The Ultimate Treasure",                            emoji: "🏥", videoId: "" },
  { id: "8-science-4",  classNum: 8, subject: "science", num: 4,  difficulty: "advanced",   title: "Electricity: Magnetic and Heating Effects",                emoji: "⚡", videoId: "" },
  { id: "8-science-5",  classNum: 8, subject: "science", num: 5,  difficulty: "elementary", title: "Exploring Forces",                                         emoji: "💪", videoId: "" },
  { id: "8-science-6",  classNum: 8, subject: "science", num: 6,  difficulty: "advanced",   title: "Pressure, Winds, Storms, and Cyclones",                    emoji: "🌪️", videoId: "" },
  { id: "8-science-7",  classNum: 8, subject: "science", num: 7,  difficulty: "advanced",   title: "Particulate Nature of Matter",                             emoji: "⚛️", videoId: "" },
  { id: "8-science-8",  classNum: 8, subject: "science", num: 8,  difficulty: "advanced",   title: "Nature of Matter: Elements, Compounds, and Mixtures",      emoji: "🧪", videoId: "" },
  { id: "8-science-9",  classNum: 8, subject: "science", num: 9,  difficulty: "advanced",   title: "The Amazing World of Solutes, Solvents, and Solutions",    emoji: "🧫", videoId: "" },
  { id: "8-science-10", classNum: 8, subject: "science", num: 10, difficulty: "advanced",   title: "Light: Mirrors and Lenses",                                emoji: "💡", videoId: "" },
  { id: "8-science-11", classNum: 8, subject: "science", num: 11, difficulty: "advanced",   title: "Keeping Time with the Skies",                              emoji: "🌠", videoId: "" },
  { id: "8-science-12", classNum: 8, subject: "science", num: 12, difficulty: "advanced",   title: "How Nature Works in Harmony",                              emoji: "🌿", videoId: "" },
  { id: "8-science-13", classNum: 8, subject: "science", num: 13, difficulty: "advanced",   title: "Our Home: Earth, a Unique Life Sustaining Planet",         emoji: "🌍", videoId: "" },
];
